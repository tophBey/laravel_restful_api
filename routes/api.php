...
Route::middleware(ApiAuthMiddleware::class)->group(function(){
    ...
    Route::get('/contacts/{idContact}/addresses/{idAddresses}', [AddressController::class,'get'])->where('idContact','[0-9]+')->where('idAddresses','[0-9]+');
    Route::put('/contacts/{idContact}/addresses/{idAddresses}', [AddressController::class,'update'])->where('idContact','[0-9]+')->where('idAddresses','[0-9]+');
    Route::delete('/contacts/{idContact}/addresses/{idAddresses}', [AddressController::class,'delete'])->where('idContact','[0-9]+')->where('idAddresses','[0-9]+');
